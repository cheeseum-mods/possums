...
public class PossumTamedLayer<T extends PossumEntity> extends GeoRenderLayer<T> {
    private static final ResourceLocation TEXTURE = new ResourceLocation(Possums.MOD_ID, "textures/entity/possum_tamed.png");


    public PossumTamedLayer(GeoRenderer<T> entityRendererIn) {
